...
o build SHALL emitir `search-index.json`; um JS estático de assets SHALL carregar o index
e renderizar os resultados. A busca SHALL degradar graciosamente sem JS.
