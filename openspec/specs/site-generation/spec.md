...
Gerar o site estático inteiramente em Typst, via bundle export, a partir dos mesmos
arquivos de post usados no livro.
...
renderizado a partir do módulo importado. A saída SHALL ir para `dist/`.
