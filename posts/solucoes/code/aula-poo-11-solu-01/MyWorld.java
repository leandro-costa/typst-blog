...
public class MyWorld extends World
{
    ...
    public void act(){
        ...
        if(contador % velocidade == 0){
            ...
            // Ampliado para incluir Uva, Cenoura, Tomate, Sorvete, Chocolate
            // e Pedra (experimento: não implementa Comestivel).
            int escolha = Greenfoot.getRandomNumber(10);
            Actor a = null;
            switch (escolha){
                ...
                case 4: a = new Uva();break;
                case 5: a = new Cenoura();break;
                case 6: a = new Tomate();break;
                case 7: a = new Sorvete();break;
                case 8: a = new Chocolate();break;
                default: a = new Pedra();break;
            }
